...
public class RSAKeyPair {
  ...
  // 生成公钥／私钥对:
  private RSAKeyPair() throws GeneralSecurityException {
  ...
  private RSAKeyPair(byte[] pk, byte[] sk) throws GeneralSecurityException {
  ...
  // 用公钥加密:
  private byte[] encrypt(byte[] message) throws GeneralSecurityException {
